    ...
    <div class="overview">
        ...
        <div class="search-form">
            <form method="GET" action="">
                <input type="text" name="search" placeholder="Search by name, phone, or email" value="<?php echo $searchQuery; ?>">
                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                            ...
                            echo "<td><a href='helpers/delete-student.php?id=" . $row["id"] . "' onclick='return confirm(\"Are you sure you want to delete this student?\")'>Delete</a></td>";
                            echo "</tr>";
                            $i++;
                        }
                    } else {
